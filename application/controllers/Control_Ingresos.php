...
class control_ingresos extends CI_Controller
{
...
//******************************************
    //Llamado a Vistas
//******************************************
    public function listar_ingreso_bodegas()
    {
            ...
            $data['title'] = "Listado de Movimientos de Ingreso de Mercaderia";
    // add breadcrumbs
    ...
    // output
            ...
            $data['lista_ingresos']=$this->model_servicios->listar_guias_ingreso();
         
            $this->template->write('title', $data['title'], true);
            $this->template->write_view('content', 'view_ingresos/listar_movimientos_ingresos', $data, true);
            $this->template->render();
    }

public function movimientos_ingreso()
    {
            if (!$this->ion_auth->logged_in()) {
                // redirect them to the login page
                redirect('autenticacion/login', 'refresh');
    ...
    // output
            ...
            $this->template->write('title', $data['title'], true);
            $this->template->write_view('content', 'view_ingresos/view_ingresos', $data, true);
            $this->template->render();
    }
