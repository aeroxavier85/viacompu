...
//******************************************
    ...
    // add breadcrumbs
            ...
            $this->breadcrumbs->push('Servicios', '/Inventario/');
    ...
    // output
            ...
            $this->template->write_view('content', 'inventario/view_inventario', $data, true);
            $this->template->render();
    }

 
    public function obtener_inventario_por_criterios()
    {
        $this->load->model('model_inventario');
         $empresa=$this->input->post("empresa");
         $bodega=$this->input->post("bodega");
      
        $str_json=$this->model_inventario->obtener_inventario_por_criterios($empresa,$bodega);
