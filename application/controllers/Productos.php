...
public function listar_productos()
    {
            ...
            $data['title'] = "Matriz de Productos";
    // add breadcrumbs
            $this->breadcrumbs->push('Inicio', '/');
            $this->breadcrumbs->push('ingresos', '/Productos/');
    ...
    // output
            ...
            $data['lista_productos']=$this->model_servicios->obtener_lista_productos();
            ...
            $this->template->write_view('content', 'productos/listar_productos', $data, true);
            $this->template->render();
    }

    public function obtener_bodegas_por_empresa(){
        $this->load->model("model_servicios");
         $id_empresa=$this->input->post("id_empresa");
      
        $str_json=$this->model_servicios->obtener_bodegas_por_empresa($id_empresa);
