    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="modal-footer">
                  <button  class="btn btn-primary" id='abrir_guia_entre_bodegas' onclick="abrir_guia_entre_bodegas()">Abrir Guía </button>
              ...
              <div class="box box-success"> 
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                           <input type='text' class="form-control" id="cod_barras_busqueda" readonly="readonly" placeholder="Ej:  0121547E8"> 
                      </div>
                    </div>
                    <hr>
                    <div class="row">
                ...
                <div class="modal-footer">
                  <button  class="btn btn-success" id='enviar_guia_bodegas' disabled="disabled" onclick="cerrar_guia_movimientos()" >Cerrar Guía y Enviar</button>
                  <button   class="btn btn-success" id='agregar_guia_bodegas' onclick="valida_codigos_repetidos_movimientos_internos()" disabled="disabled" >Agregar a Guía</button>
                </div>
